...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _start() {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(builder: (_) => SwipeScreen(project: project)),
    );
  }
          ...
          child: Column(
            children: [
              ...
              Wrap(
                spacing: 8,
                runSpacing: 8,
                children: _examples.map((e) => _ExampleChip(
                  label: e,
                  onTap: () => setState(() => _controller.text = '$eを作りたい'),
                )).toList(),
              ),
              const Spacer(),
              SizedBox(
...
class _Logo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      const Text('Dopamine Driven Development',
